...
class CustomAdvancedPaginatedDataTable extends StatefulWidget {
  ...
  CustomAdvancedPaginatedDataTable({
    Key? key,
    this.header,
    this.actions,
  ...
  static const int defaultRowsPerPage = 8;
...
class PaginatedDataTableState extends State<CustomAdvancedPaginatedDataTable> {
  ...
  @override
  void didUpdateWidget(CustomAdvancedPaginatedDataTable oldWidget) {
