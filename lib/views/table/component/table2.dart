...
class MyTable2 extends StatefulWidget {
  MyTable2({Key? key}) : super(key: key);
  ...
  Widget _getBodyWidget() {
    return Container(
      child: HorizontalDataTable(
        leftHandSideColumnWidth: MediaQuery.of(context).size.width * 0.1,
        rightHandSideColumnWidth: MediaQuery.of(context).size.width * 0.9,
        isFixedHeader: true,
