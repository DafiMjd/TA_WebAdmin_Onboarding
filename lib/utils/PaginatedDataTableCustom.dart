...
class PaginatedDataTableCustom extends StatefulWidget {
  ...
  /// particular [PaginatedDataTableCustom] widget is created; avoid creating a new
  /// [DataTableSource] with each new instance of the [PaginatedDataTableCustom]
  ...
  /// To modify the border or background color of the [PaginatedDataTableCustom], use
  ...
  /// [PaginatedDataTableCustom] widget itself; it should be reused each time the
  /// [PaginatedDataTableCustom] constructor is called.
...
/// Holds the state of a [PaginatedDataTableCustom].
///
